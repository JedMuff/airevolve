...
class Figure8Gates(GateConfig):
    ...
    """
    gate_pos = np.array([
        [  1.5, -1.5,  0.0],  # Gate 0: Lower right
        [  3.0,  0.0,  0.0],  # Gate 1: Far right
        [  1.5,  1.5,  0.0],  # Gate 2: Upper right
        [  0.0,  0.0,  0.0],  # Gate 3: Center
        [ -1.5, -1.5,  0.0],  # Gate 4: Lower left
        [ -3.0,  0.0,  0.0],  # Gate 5: Far left
        [ -1.5,  1.5,  0.0],  # Gate 6: Upper left
        [  0.0,  0.0,  0.0],  # Gate 7: Return to center
    ], dtype=np.float64)
