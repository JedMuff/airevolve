#!/usr/bin/env bash
# =============================================================================
# run_exp2.sh — Experiment 5: Sparse End-of-Episode Energy Penalty
# =============================================================================
#
...
# Output root:     /local/data/mdu219/drone-experiment-5/
#
...
BASE_DIR="/local/data/mdu219/drone-experiment-5"
...
echo "========================================================================"
echo "  Experiment 5 — Sparse End-of-Episode Energy Penalty"
echo "  Sweep: ${WEIGHTS[*]}"
