...
if (($SLURM_ARRAY_TASK_ID == 0)) ; then
    ...
    srun python3 examples/evolution/run_evolution.py --population-size 12 --generations 40 --gate-cfg slalom --num-envs 100 --strategy-type plus --symmetry none --log-dir ./logs/
    ...
    srun python3 examples/evolution/run_evolution.py --population-size 12 --generations 40 --gate-cfg backandforth --num-envs 100 --strategy-type plus --symmetry none --log-dir ./logs/
    ...
    srun python3 examples/evolution/run_evolution.py --population-size 12 --generations 40 --gate-cfg figure8 --num-envs 100 --strategy-type plus --symmetry none --log-dir ./logs/
    ...
    srun python3 examples/evolution/run_evolution.py --population-size 12 --generations 40 --gate-cfg figure8 --num-envs 100 --strategy-type plus --symmetry yz --log-dir ./logs/
