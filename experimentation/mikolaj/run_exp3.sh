#!/usr/bin/env bash
# =============================================================================
# run_exp1.sh — Experiment 3: Dense Timestep Power Penalty
# =============================================================================
#
...
# Output root:     /local/data/mdu219/drone-experiment-3/
#
# Server requirements
# -------------------
...
BASE_DIR="/local/data/mdu219/drone-experiment-3"
...
echo "========================================================================"
echo "  Experiment 3 — Dense Timestep Penalty"
echo "  Sweep: ${WEIGHTS[*]}"
