...
episode length, and episode count once every `window` env steps.

Vendored from `experimentation/window_metrics_callback.py` so this example
is self-contained and does not depend on the experimentation/ sys.path.
"""
